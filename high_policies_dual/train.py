...
parser = argparse.ArgumentParser(description="Train dual-flagella dual independent-policy senior policy")
...
POLICY_DIR = os.path.join(os.getcwd(), f"dual_policy_{TIMESTAMP}")
...
def write_training_run_markdown(run_dir, cli_args, trainer_config, visualizer_snapshot_path, swimmer_snapshot_path):
    ...
    lines = [
        "# Dual Independent-Policy Training Run Parameters",
        "",
