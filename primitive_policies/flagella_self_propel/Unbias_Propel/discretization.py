...
def main():
    ...
    torch.save(torch.from_numpy(Xf_match_q), BASE_DIR / 'Xf_match_q_fila.pt')
    torch.save(torch.from_numpy(Yf_match_q), BASE_DIR / 'Yf_match_q_fila.pt')
    torch.save(torch.from_numpy(Zf_match_q), BASE_DIR / 'Zf_match_q_fila.pt')
    torch.save(torch.from_numpy(Min_Distance_Label), BASE_DIR / 'Min_Distance_Label_Fila.pt')
    torch.save(torch.from_numpy(Xf_all), BASE_DIR / 'Xf_all_fila.pt')
    torch.save(torch.from_numpy(Yf_all), BASE_DIR / 'Yf_all_fila.pt')
    torch.save(torch.from_numpy(Zf_all), BASE_DIR / 'Zf_all_fila.pt')
    torch.save(torch.from_numpy(Min_Distance_num), BASE_DIR / 'Min_Distance_num_fila.pt')
    torch.save(torch.from_numpy(Correponding_label), BASE_DIR / 'Correponding_label_fila.pt')
    print(Correponding_label)
